...
4. enables NetworkManager and the normal `tty1` first-boot password setup while
   disabling systemd-networkd and SSH; the diagnostic variant redirects that
   setup to USB `ttyGS0`; and
